					...
					<div class="col-xs-12">
						...
						<form id="formSubmit">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea rows="" cols="" id="shortDescription" name="shortDescription" style="width: 943px; height: 70px">${model.shortDescription}</textarea>
...
function addNew(data) {
    $.ajax({
        ...
        dataType: 'json',//kiểu data trả về cho clinet
